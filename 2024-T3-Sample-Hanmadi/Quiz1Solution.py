...
'''
Complete the code in the function that, given a list L of random non negative whole numbers, 
decomposes L into a list R of increasing sequences and with consecutive duplicates removed.
'''
